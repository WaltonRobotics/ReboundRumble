...
public class OI {
    ...
    public static boolean driverControlled;
    ...
    public OI() {
        leftButton1.whileHeld(new MainConveyor(55.0, true));
        leftButton1.whenReleased(new MainConveyor(55.0, false));
...
//        rightButton5.whenReleased(new StopShooterWheels());
        leftButton6.whenPressed(new ChangeBallCount(1));
        leftButton7.whenPressed(new ChangeBallCount(-1));
        
        rightButton1.whenPressed(new obliterate());
        rightButton2.whileHeld(new MainConveyor(.75, false));
        rightButton3.whileHeld(new MainConveyor(-.75, false));
        rightButton5.whileHeld(new AutoAim());
        rightButton5.whenReleased(new ZeroTurret());

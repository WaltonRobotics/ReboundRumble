 ...
 * @author Chris
 */
public class AutoShotAutonomous extends CommandBase 
{

    /**
     * bolean finished is what isFinished for this Command returns. the reason for this
    ...
    private double lastTY = 240;
    /**
     * The speed the shooter will default to if no target is found. Update teleop
     * version if changed
     */
...
//        logger.logMessage("Beginning AutoShotAutonomous");
    ...
    protected void execute() {
        ...
        try {
                ...
                if(topY>lastTY+10||topY<lastTY-10)
                {
                    timeToShoot = true;
                    lastTY = topY;
                }

...
public class OI {
    ...
    public double getTopWheels() {
        ...
        return -topPower; //this needs to be changed back when they wire it correctly. If they don't tell you when that is, its when the top wheel starts spinning backwards.
    }

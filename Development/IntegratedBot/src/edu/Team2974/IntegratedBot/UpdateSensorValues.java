...
//moves all subsystem code of senors to one easily accessible spot
    ...
    public void update()
    {
        SmartDashboard.putBoolean("Entry Ball Sensor", oldA);
        SmartDashboard.putBoolean("Middle Ball Sensor", oldB);
        SmartDashboard.putBoolean("Shooter Ball Sensor", oldC);
        SmartDashboard.putInt("Ball Count", balls);
    }
}

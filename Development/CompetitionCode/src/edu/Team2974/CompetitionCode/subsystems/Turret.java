...
import edu.Team2974.CompetitionCode.commands.ZeroTurret;
//import edu.Team2974.IntegratedBot.subsystems.DummyVisionCamera;
...
public class Turret extends Subsystem {
   ...
   public Turret () {
    ...
    /**
     * assigns the potentiometer voltage to the double potenetiometerVoltage and returns it
    ...
    /**
     * this is supposed to be the autoAim method that rotates to turret at progressively 
     * lower speeds as it gets closer, but so far I have nothing here because I have no 
    ...
    public void update()
    {
        SmartDashboard.putDouble("Potentiaometer Voltage", potentiometer.getVoltage());
    }
}

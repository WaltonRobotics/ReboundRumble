...
//        try {
//            boolean foundIt = OI.targetTable.getBoolean("Target Found");
...
//        return true;
     ...
     * @param the center y of the current target @return the amount of voltage
     * to set the jags to so that the ball will hit the target
     */
